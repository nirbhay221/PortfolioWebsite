...
export default function MclarenModel() {
  let ref = useRef();
  let myMesh = useRef();
  const { scene, nodes, materials } = useGLTF('./carmodel/mclarencar.glb')
...
useGLTF.preload("./carmodel/mclarencar.glb");
