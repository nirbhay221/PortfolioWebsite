...
export default function MapAd() {
  ...
  const [video] = useState(() => Object.assign(document.createElement('video'), { src: './Videos/GameTracks.mp4', crossOrigin: 'Anonymous', loop: true, muted: true }))
        useEffect(() => void video.play(), [video])
  return (
   
      <group        position={[-41,1.5,15]}         rotation={[-Math.PI*1 , 0.5*Math.PI, 0.5*Math.PI]}>
