...
export default function Phone() {
  ...
  const [video] = useState(() => Object.assign(document.createElement('video'), { src: './Videos/THREE.mp4', crossOrigin: 'Anonymous', loop: true, muted: true }))
        useEffect(() => void video.play(), [video])
  return (
   
      <group position={[0,1.2,-10]} rotation={[-Math.PI*1 , 0.5*Math.PI, 0.5*Math.PI]}>
